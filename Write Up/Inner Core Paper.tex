...
Because we do not know a-priori the actual velocity structure being measured, we perform analysis on three distinct velocity models. These are shown in figure \ref{fig:Velocity models}. In each case we vary the velocity jump at the ICB to realistic figures based on \cite{Waszek2011a}.
