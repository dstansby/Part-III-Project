...
The end goal of this study is to calculate velocity structure perturbations using equation \eqref{eq:Delta v}. In what follows it will therefore be useful to measure how $t$, the time a PKIKP ray spends in the inner core, varies as a function of both epicentral distance from the source, and bottoming depth below the ICB.
